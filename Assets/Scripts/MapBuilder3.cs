...
public class MapBuilder3 : MonoBehaviour
{
    [TextAreaAttribute] public string comment = "frequency Hints \n" +
    ...
    void Start()
    {
        ...
        Debug.Log("time = " + time.ToString().Split(':')[2]);
        Debug.Log("restarts = " + restart);
        Debug.Log("last time = " + lastTime.ToString().Split(':')[2]);
    }
    ...
    void Collapse(GridCell cell)
    {
        ...
        float rndRange = cell.possibleTiles.Sum(poss => poss.frequencyNotes);
