...
public class TileManager4 : MonoBehaviour
{
    ...
    void Collapse(WaveCell cell)
    {
        ...
        {
            if (rndValue > cell.possibleTiles[i].frequencyHints)
            {
                rndValue -= cell.possibleTiles[i].frequencyHints;
            }
            else
            {
                rndID = i;
